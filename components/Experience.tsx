...
},
{
  ...
  type: 'Internship',
  highlights: [
    'Development of an internal web application for email address filtering with classification according to Softbounce and Outbounce principles',
    'Development of mobile inspection applications and PDF report generation',
    'Development of a mobile electrical audit application with data export to JSON and generation of PDF and Word reports',
    'Participation in the development of the audit platform for electrical and commercial assets of the company SOCADEL',
    'Implementation of a professional email marketing campaign using Outlook and MS Word',
    'Design and development of an internal mini ERP communicating with Odoo and com',
  ],
},
],
    education: {
  ...
  fr: {
    ...
    },
    {
      ...
      type: 'Stage',
      highlights: [
        'D‌éveloppement d’une application web interne de filtrage d’adresses mail avec classification suivantles principes Softbounce et Outbounce',
        'Dével‌oppement d’applications mobiles d’inspection et de génération de rapports PDF.‌',
        'Développement d’une application mobile d’audit électrique avec exportation de donnéesen Json et génération de rapports PDF et Word.‌',
        'Participation au développement de la plateforme d’audit des actifs électriques et commerciaux de l’entreprise SOCADEL.‌',
        'Mise en place d’une campagne de mailing professionnelle avec Outlook et Ms Word.‌',
        'Conception et développement d’un mini ERP interne communiquant avec Odoo et com',
      ],
    },
    ],
    education: {
